...
// GetChildrenRequest collects the request parameters for the GetChildren method.
type GetChildrenRequest struct {
	Id string `json:"id"`
}

// GetChildrenResponse collects the response parameters for the GetChildren method.
type GetChildrenResponse struct {
	T     []*io.Todo `json:"t"`
	Error error      `json:"error"`
}

// MakeGetChildrenEndpoint returns an endpoint that invokes GetChildren on the service.
func MakeGetChildrenEndpoint(s service.TodoService) endpoint.Endpoint {
	return func(ctx context.Context, request interface{}) (interface{}, error) {
		req := request.(GetChildrenRequest)
		t, error := s.GetChildren(ctx, req.Id)
...
// Failed implements Failer.
func (r GetChildrenResponse) Failed() error {
	return r.Error
}
...
func (e Endpoints) SetStar(ctx context.Context, id string, star uint8) (error error) {
...
// GetChildren implements Service. Primarily useful in a client.
func (e Endpoints) GetChildren(ctx context.Context, id string) (t []*io.Todo, error error) {
	request := GetChildrenRequest{Id: id}
	response, err := e.GetChildrenEndpoint(ctx, request)
	if err != nil {
		return
	}
	return response.(GetChildrenResponse).T, response.(GetChildrenResponse).Error
}
